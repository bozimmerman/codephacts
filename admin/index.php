    ...
    <div class="container">
        <div class="card">
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin: 20px 0;">
                ...
                <div style="text-align: center; padding: 20px; background: #e7f3ff; border-radius: 8px;">
                    <h3 style="font-size: 2.5em; margin: 0; color: #007bff;"><?= number_format($totalLines) ?></h3>
        ...
        <div class="card">
            ...
            <button onclick="if(confirm('Run phactor.php to update all projects?')) window.location.href='run-update.php'" class="button secondary">Run Update</button>
        </div>
    </div>
</body>
</html>